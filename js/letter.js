...
const MESSAGE = `
HAPPY VALENTINE DAY นะคะ เค้ารักเธอน้าาาา 
วันพิเศษของเค้าคือการมีเธอทู้กกกกวัน เค้ารักเธอนะคะอ้วน รักเธอที่สุด
อยู่ด้วยกันไปทุกๆวันนะคะ ต่อจากนี้ และทุกวันเค้าจะดูแลอ้วนเองนะคะ 💕🎀👩‍❤️‍💋‍👨🌻
`;
